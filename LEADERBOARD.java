...
public class LEADERBOARD extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                // Uncomment the line below and replace "username" with an actual value when testing
                 new LEADERBOARD("username").setVisible(true);

                // Comment the line below or remove it completely
